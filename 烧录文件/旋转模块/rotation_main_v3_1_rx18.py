...
#   LoRa UART2:  RX=GPIO18, TX=GPIO17, 115200
#   LoRa AUX:    GPIO26
#   LoRa M0:     GPIO33 -> LOW
#   LoRa M1:     GPIO32 -> LOW
#
...
def process_complete_lines():
    ...
    while True:
        ...
        # MicroPython bytearray does not support item deletion with `del`.
        # Rebuild the remaining buffer instead.
        next_pos = pos + 1
        buf_len = len(rx_buf)
...
def main():
    ...
    debug("LoRa UART2 RX=GPIO18 TX=GPIO17 @115200")
